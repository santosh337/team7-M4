...
<td><input type = "text" class = "form-control totalItemPrice" disabled randomly> </td>
...
const formatteDate = currentDate.toISOString().slice(0,10);
$("#invoiceDate").val(formatteDate);
